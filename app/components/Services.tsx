...
const SERVICES: Service[] = [
  ...
  { name: "מניקור + לק ג׳ל ומבנה אנטומי", price: "בהמשך" },
  {
    name: "מילוי בבילד אפ",
    price: "160 ₪",
    description:
  ...
  { name: "בניה בג׳ל עם טיפס הפוך", price: "בהמשך" },
  { name: "הסרת ג׳ל ללא חידוש", price: "35 ₪" },
  {
    name: "תיקון ציפורן בודדת",
    price: "15 ₪",
    description:
      "מיועד למי שמגיעה לתיקון נקודתי בלבד, שלא במסגרת תור שירות. אם יש יותר משתי ציפורניים לתיקון - אנא ציינו בהערות התור.",
  },
];
