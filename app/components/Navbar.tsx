...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between" style={{ padding: "10px" }}>
        <a
          href="#hero"
        ...
        >
          <Image
            ...
            style={{ filter: "drop-shadow(0 2px 4px rgba(138,112,96,0.2))" }}
          />
          <span
        ...
        <a
          ...
          className="hidden md:inline-flex items-center gap-2.5 px-6 py-3 rounded-full text-white text-sm font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg"
